...
export function AppearanceSection({isMacOS,
                                    isWindows,
                                    followSystem,
                                    setFollowSystem,
                                    theme,
                ...
                {!backgroundImage ? (
                    <>
                      <Button
                          ...
                          size="sm"
                          className="h-auto px-3 py-1.5 text-xs bg-foreground text-background hover:opacity-90"
                      >
                        选择文件
                      </Button>
                      <Button
                ...
                <Item variant="outline" className="border-0">
                  ...
                  <ItemActions>
                    <Select
                        ...
                        onChange={(value) => setIntervalTime(parseInt(value as string, 10))}
                        size="sm"
                        className="w-28"
                    />
                  </ItemActions>
                      ...
                      <Item variant="outline" className="border-0">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("videoVolume", numValue.toString());
                              window.dispatchEvent(new Event("videoVolumeChanged"));
                            }}
                            className="w-12 h-4 text-center text-xs text-foreground bg-muted rounded-md outline-none"
                        />
